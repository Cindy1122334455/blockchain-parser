...
from .utils import pubkey_to_address
...
class Script(object):
    ...
    @property
    def publicKeyAddress(self):
        """Returns the public key address from CScript object"""
        ...
        if self._value == "INVALID_SCRIPT" or len(self._value.split()) != 2:
            return ""
        else:
            return pubkey_to_address(self._value.split()[1])
